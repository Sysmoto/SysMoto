...
$pedidos= listar_pedidos($MiConexion);
                          ...
                          <caption class="ms-4"> &nbsp; </caption>
                            ...
                            <?php for ($i=0; $i<$CantidadPedidos; $i++) { ?>               
                              ...
                              <tr>
                                ...
                                <strong><?php echo $pedidos[$i]['PEDIDO_ID']; ?></strong></td>
                                <td>
                                <strong><?php echo $pedidos[$i]['PROVE_NOMBRE']; ?></strong></td>
                                <td><?php echo $pedidos[$i]['PEDIDO_FECHACREACION'];?></td>
                                <td><?php echo $pedidos[$i]['PEDIDO_FECHAENVIO'];?></td>
                                <td><?php echo $pedidos[$i]['PEDIDO_FECHACIERRE'];?></td>
