              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  ...
                  <table class="table" id="example1">
                    ...
                    <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $usuarios[$i]['Usuario']?></strong></td>
                        ...
                        <?php if($usuarios[$i]['Activo'] == 1) { ?>
                          ...
                          <?php }
                              ...
                              <td><span class="badge bg-label-danger me-1">Desactivo</span></td>
                           <?php } ?>

                           <td><?php echo $usuarios[$i]['Rol'];?></td>
                           <td><?php echo $usuarios[$i]['Sexo'];?></td>
                           
                        <td>
                          <button type="submit" class="btn btn-secondary" name="id_user" value="<?php echo $usuarios[$i]['Id'];?>" >
